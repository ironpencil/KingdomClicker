...
class SamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sample" do
    assert_difference('Sample.count') do
      post samples_url, params: { sample: { description: @sample.description, name: @sample.name } }
    end
  ...
  test "should update sample" do
    patch sample_url(@sample), params: { sample: { description: @sample.description, name: @sample.name } }
